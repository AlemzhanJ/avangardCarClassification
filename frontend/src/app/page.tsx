            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 p-2 rounded-full border border-gray-300 dark:border-gray-600 hover:border-indrive-green transition-colors bg-white dark:bg-gray-800"
                >
